...
#   Command prompt
#------------------------------------------------------------
# Zsh equivalent of bash PS1 - shows full path
PROMPT='%F{cyan}%/%f $ '
...
#------------------------------------------------------------
#   Zsh VCS Info (Git branch display)
#------------------------------------------------------------
...
alias show_options='setopt'                 # Show_options: display zsh options settings (zsh equivalent of shopt)
alias fix_stty='stty sane'                  # fix_stty:     Restore terminal settings when screwed up
alias cic='setopt CASE_GLOB'                # cic:          Make tab-completion case-insensitive (zsh equivalent)
...
alias gPull='ls | xargs -P10 -I{} git -C {} pull'
