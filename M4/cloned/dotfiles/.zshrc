...
# Richer tab completion: menu (navigate with arrows) and descriptions for options
...
# libpq (psql) so pnpm db:local:seed uses psql instead of Docker fallback
export PATH="/opt/homebrew/opt/libpq/bin:$PATH"

# Added by Antigravity
export PATH="/Users/jonasdeibe/.antigravity/antigravity/bin:$PATH"

# GitHub token for Claude Code MCP plugin
export GITHUB_PERSONAL_ACCESS_TOKEN=$(gh auth token 2>/dev/null)  # or set manually
